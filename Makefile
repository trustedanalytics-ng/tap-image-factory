...
run-local: build
	IMAGE_FACTORY_PORT=8080 HUB_ADDRESS="http://localhost:5000" BLOB_STORE_HOST="http://localhost" BLOB_STORE_PORT=8084 DOCKER_API_VERSION="1.23" DOCKER_HOST="unix:///var/run/docker.sock"  $(GOPATH)/bin/tapng-image-factory
